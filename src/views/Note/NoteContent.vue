      ...
      <div v-show="widget.mouseover" class="buttons">
        ...
        <div class="button-icon">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" @click="widget.type = 'heading'">TITLE</a>
            <a class="dropdown-item" @click="widget.type = 'body'" >CONTENT</a>
            <a class="dropdown-item" @click="widget.type = 'code'" >SOURCE CODE</a>
          </div>
        </div>
      </div>
    </div>
